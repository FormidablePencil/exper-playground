...
function Crystal10({ image }) {
  return (
    <svg viewBox="0 0 278 299">
      <defs>
        <filter id="luminosity-noclip" x="97.52" y="70.09" width="105" height="128" filterUnits="userSpaceOnUse"
      ...
      <g className="cls-1">
        <g id="Shard_11" data-name="Shard 11">
          <polygon className="cls-4" points="161.38 182.05 199.87 78.19 190.68 80.1 99.48 151.01 117.86 201.81 161.38 182.05" />
          <g className="cls-5-crystal10">
            <g className="cls-6">
        ...
        <g id="Sheens">
          <polygon className="cls-8" points="192.15 85.23 143.98 165.33 136.79 165.33 155.2 175.53 192.15 85.23" />
          <polygon className="cls-8" points="177.39 93.67 108.41 150.85 123 155.47 177.39 93.67" />
          <polygon className="cls-8" points="119.62 194.31 122.81 161.5 105.99 154.44 119.62 194.31" />
          <polygon className="cls-8" points="126.74 189.95 128.04 168.45 154.15 181.89 126.74 189.95" />
        </g>
      </g>
    </svg>
  )
